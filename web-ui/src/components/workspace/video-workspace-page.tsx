...
export function VideoWorkspacePage() {
 ...
 <div className="workspace-panel overflow-hidden rounded-[var(--panel-radius)] border border-[var(--glass-border)] bg-[color-mix(in_srgb,var(--bg-2)_calc(var(--glass-opacity)*70%),transparent)] bg-clip-padding p-4">
